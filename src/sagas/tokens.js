...
export function* fetchTokens() {
  ...
  // const arbitrableTokenListInstance = new ETHWeb3.eth.Contract(
  ...
  //   ERC20_ADDRESS
  // )
  // const TokensViewInstance = new ETHWeb3.eth.Contract(
  //   TokensView.abi,
  //   TOKENS_VIEW_ADDRESS
  // )
  const tokens = [
  ...
  //     ERC20BadgeInstance.methods.queryAddresses(
  //       lastAddress,
  //       1000,
  ...
  //     TokensViewInstance.methods.getTokensIDsForAddresses(
  //       T2CR_ADDRESS,
  //       query.values.filter((addr) => addr !== ZERO_ADDRESS)
  //     ).call
  ...
  //         call(async () => {
  //           const token = {}
  //           const _token = await arbitrableTokenListInstance.methods
  //             .tokens(tokenID)
  //             .call()
  ...
  //               : `https://production-doges-on-trial-doge-images.s3.us-east-2.amazonaws.com/${
  //                   _token.symbolMultihash
  //                 }`
